<template>
  <div class="applay" @click="onBlur">
      ...
      <div class="form-box">
        ...
        <cell-group>
           <p class="title-item">用车类型<img  @click="openCarType" src="../../../assets/images/applay_add.png" class="img-add" alt=""></p>
           <div class="carList">
...
export default {
  ...
  data () {
    return {
      ...
      form: {
        apply_name_id: '', // apply_name_id（申请人id/int）
        apply_dept_id: '', // apply_dept_id（申请单位id/int）
        apply_name_phone: '', //
        yong_che_ren: '', // yong_che_ren（用车人/string）
        apply_use_phone: '', // apply_name_phone（申请人电话/string）
      ...
      preList({}, (res) => {
        ...
        // 通过订单id获取回显数据
          getApplyInfoById({ applyId: this.form.id }, (resEdite) => {
            ...
            if (this.form.yong_che_xz === 3) {
              this.isXinghao = true
              getTask({
                auditId: this.form.audit_user_id,
