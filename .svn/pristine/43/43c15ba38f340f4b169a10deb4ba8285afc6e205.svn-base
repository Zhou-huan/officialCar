...
<script>
import 'vux/src/styles/weui/widget/weui_cell/weui_access.less'
import 'vux/src/styles/weui/widget/weui_cell/weui_cell_global.less'
import 'vux/src/styles/weui/widget/weui_cell/weui_form/weui_form_common.less'
import 'vux/src/styles/weui/widget/weui_cell/weui_form/weui_vcode.less'
import Base from 'vux/src/libs/base'
import isEmail from 'validator/lib/isEmail'
import isMobilePhone from 'validator/lib/isMobilePhone'
import Debounce from 'vux/src/tools/debounce'
import mask from 'vanilla-masker'
import { Icon, Toast, InlineDesc } from 'vux'
const validators = {
  email: {
    fn: isEmail,
    msg: '邮箱格式'
